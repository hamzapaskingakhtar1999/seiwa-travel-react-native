  ...
  return (
    <View className="bg-white flex-1">
      ...
      <SafeAreaView className="flex-row justify-between items-center w-full absolute">
        ...
        >
          <Ionicons name="caret-back" size={wp(7)} color="white" />
        </TouchableOpacity>
      ...
      <View
        ...
        className="px-5 flex flex-1 justify-between bg-white pt-8 -mt-8"
      >
        <ScrollView showsVerticalScrollIndicator={false} className="space-y-5">
          ...
          <View className="flex-row justify-between mx-1">
            <View className="flex-row space-x-2 items-start">
              <AntDesign name="clockcircleo" size={wp(7)} color="skyblue" />
              <View className="flex space-y-2">
                <Text
                  style={{ fontSize: wp(4.5) }}
                  className="font-bold text-neautral-700"
                >
                  {item.duration}
                </Text>
            ...
            <View className="flex-row space-x-2 items-start">
              <Feather name="map-pin" size={wp(7)} color="tomato" />
              <View className="flex space-y-2">
                <Text
                  style={{ fontSize: wp(4.5) }}
                  className="font-bold text-neautral-700"
        ...
        <TouchableOpacity
          ...
          className="m-3 mx-auto flex justify-center items-center rounded-full"
        >
